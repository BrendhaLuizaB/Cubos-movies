...
const DetailsPage = () => {
  ...
  const { setMovieClicked, data, details, video } = useContext(GlobalContext);
          ...
          <div className="flex flex-col mx-5 justify-around sm:justify-center md:justify-center">
            <div className="flex mt-10 flex-wrap items-center gap-6">
              ...
              <div className="flex items-center flex-wrap">
                ...
                <div className="p-4" style={{ backgroundColor: "#44414979" }}>
                  <h2 className="text-mauveDark-mauve11 font-bold ">VOTOS</h2>
                  <h2 className="text-purple-purple2 font-semibold">
                    {details?.vote_count}
                  </h2>
                </div>
                <div
                  ...
                  style={{
                    backgroundColor: "#44414979",
                    border: "solid 4px #FFE000",
                  }}
                >
            ...
            <div className="flex mt-5 flex-wrap">
              <div
                ...
                style={{ backgroundColor: "#44414979" }}
              >
                <h1 className="text-mauveDark-mauve11 font-bold">SINOPSE:</h1>
                <p className="text-purple-purple2 font-light">
                  {details?.overview}
                </p>
              </div>
              <div className="md:mt-5 sm:mt-5">
                <div className="flex ml-5 sm:mt-5">
                  ...
                  <div className="p-2" style={{ backgroundColor: "#44414979" }}>
                    <h2 className="text-mauveDark-mauve11 font-bold">
                      DURAÇÃO
                    </h2>
                    <h2 className="text-purple-purple2 font-semibold">
                ...
                <div className="flex ml-5 mt-5">
                  ...
                  <div className="p-2" style={{ backgroundColor: "#44414979" }}>
                    <h2 className="text-mauveDark-mauve11 font-bold">IDIOMA</h2>
                    <h2 className="text-purple-purple2 font-semibold">
                ...
                <div className="flex ml-5 mt-5">
                  ...
                  <div className="p-2" style={{ backgroundColor: "#44414979" }}>
                    <h2 className="text-mauveDark-mauve11 font-bold">LUCRO</h2>
                    <h2 className="text-purple-purple2 font-semibold">
                      ${profit}
                    </h2>
                  </div>
            ...
            <div style={{ backgroundColor: "#44414979" }} className="my-5 p-5">
